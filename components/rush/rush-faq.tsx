...
export default function RushFAQ() {
  ...
  const faqItems: FAQItem[] = [
    {
      question: "How is Alpha Kappa Psi different from other business organizations?",
      answer: [
    ...
    },
    {
      ...
      answer:
        "Must be an undergraduate student enrolled in the Leavey School of Business, College of Arts and Sciences, or School of Engineering at Santa Clara University with a minimum GPA of 2.0",
    },
    {
    ...
    {
      question: "Do you have to attend all Rush events in order to qualify for membership?",
      answer:
    ...
    },
    {
      ...
      answer:
        "A bid is an invitation to participate in the pledge process in preparation to joining our fraternity. To receive a bid, the vast majority of the active brothers must vote favorably for your admittance to become a pledge. In order to have our members vote favorably on your behalf, it is important that they have had the opportunity to meet and get to know you. It is therefore recommended to attend as many Rush events as possible.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "A pledge is potential member who has accepted their bid and undergone a ritual conducted by the fraternity. It is a promise made by the individual to strive to become a full member of the Brotherhood.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "No, Alpha Kappa Psi has strict policies against hazing. All pledge and active brother events are designed to build teamwork, trust, professional development, creativity, and brotherhood.",
    },
  ]
          ...
          >
            {Array.isArray(item.answer) ? (
              item.answer.map((paragraph, i) => (
                <p key={i} className={i < item.answer.length - 1 ? "mb-4" : ""}>
                  {paragraph}
                </p>
              ))
            ) : (
